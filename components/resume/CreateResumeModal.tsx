...
export function CreateResumeModal({ open, onOpenChange, onSuccess }: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[95vw] md:max-w-[90vw] lg:max-w-5xl xl:max-w-6xl max-h-[95vh] p-0 gap-0 bg-gradient-to-b from-blue-50 to-white from-white to-gray-50/50 overflow-hidden">
        {/* Header */}
