        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue('resumeId', value)}>
              ...
              <SelectContent>
                <SelectItem value="resume-1">Full Stack Developer Resume</SelectItem>
                <SelectItem value="resume-2">Frontend Developer Resume</SelectItem>
                <SelectItem value="resume-3">Backend Developer Resume</SelectItem>
              </SelectContent>
            </Select>
            {errors.resumeId && (
