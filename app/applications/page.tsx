                    ...
                    >
                      ...
                      <div className="col-span-4 space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500">
                          ...
                          <span>{app?.jobId?.company || "شرکت نامشخص"}</span>
                          {app?.jobId?.location && (
                            <>
                      ...
                      <div className="col-span-2">
                        <Badge variant="outline" className="text-xs">
                          {app?.jobId?.jobType === "full-time" && "تمام وقت"}
                          {app?.jobId?.jobType === "part-time" && "پاره وقت"}
                          {app?.jobId?.jobType === "contract" && "قراردادی"}
                          {app?.jobId?.jobType === "internship" && "کارآموزی"}
                          {app?.jobId?.jobType === "freelance" && "پروژه‌ای"}
                          {!app?.jobId?.jobType && "-"}
                        </Badge>
                      </div>
                      ...
                      <div className="col-span-2 flex items-center justify-center gap-2">
                        ...
                        {canWithdrawApp && !isWithdrawn && (
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => handleWithdrawClick(app._id, app?.jobId?.title || "این درخواست")}
