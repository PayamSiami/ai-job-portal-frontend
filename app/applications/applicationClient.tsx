  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-3">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">درخواست‌های شغلی</h1>
      ...
      <Card className="border border-gray-100 shadow-sm">
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <>
              {/* List Header - Desktop */}
              <div className="hidden md:grid grid-cols-12 gap-4 p-4 bg-gray-50 border-b text-xs font-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800">
