...
export default function ApplicationDetailPage() {
    ...
    const jobTitle = app?.job?.title || app?.jobId?.title || "جزئیات درخواست";
    const companyName = app?.job?.company || app?.jobId?.company || "شرکت نامشخص";
        ...
        <div className="space-y-6 dir-rtl">
            ...
            <Card className={cn(
                ...
                <CardContent className="p-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="flex justify-between relative">
                            ...
                            {STATUS_STEPS.map((step, index) => {
                                ...
                                const isRejected = step.value === "rejected" && app?.status?.toLowerCase() === "rejected";
                    ...
                    {/* Status Message - Fixed to use statusHistory from the correct path */}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm text-gray-700">
                                        {app.statusHistory[app.statusHistory.length - 1]?.notes || "هیچ توضیحی ثبت نشده است."}
                                    </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                                ...
                                {app?.aiRecommendation && (
                                    <div>
                                        ...
                                        <Badge variant="outline" className="mt-1">
                                            {app.aiRecommendation === "consider" ? "مناسب" :
                                                app.aiRecommendation === "recommend" ? "توصیه می‌شود" :
                                                    app.aiRecommendation === "strong_recommend" ? "توصیه قوی" :
                                                        app.aiRecommendation === "reject" ? "رد" : app.aiRecommendation}
                                        </Badge>
                                    </div>
                                )}
                            </div>
                    ...
                    {(app?.aiStrengths?.length > 0 || app?.aiWeaknesses?.length > 0 || app?.aiExplanation) && (
                        <Card>
                            <CardContent className="p-6">
                                ...
                                <div className="space-y-4">
                                    {app?.aiStrengths?.length > 0 && (
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {app.aiStrengths.map((strength: string, index: number) => (
                                    ...
                                    {app?.aiWeaknesses?.length > 0 && (
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {app.aiWeaknesses.map((weakness: string, index: number) => (
            ...
            <AlertDialog open={withdrawDialogOpen} onOpenChange={setWithdrawDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            شما در حال لغو درخواست خود برای موقعیت شغلی {jobTitle} هستید.
                            <br />
